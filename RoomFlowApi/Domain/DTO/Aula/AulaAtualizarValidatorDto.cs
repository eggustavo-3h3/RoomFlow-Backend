...
{
    public class AulaAtualizarValidatorDto : AbstractValidator<AulaAtualizarDto>
    {
        public AulaAtualizarValidatorDto() 
        {
           RuleFor(a => a.Id).NotEmpty().WithMessage("Aula não existe");
